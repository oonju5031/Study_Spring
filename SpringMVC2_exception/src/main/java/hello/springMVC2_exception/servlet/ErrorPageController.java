package hello.springMVC2_exception.servlet;
...
public class ErrorPageController {
	...
	private void printErrorInfo(HttpServletRequest request) {
		log.error("ERROR_EXCEPTION = {}", request.getAttribute(ERROR_EXCEPTION));
		log.error("ERROR_EXCEPTION_TYPE = {}", request.getAttribute(ERROR_EXCEPTION_TYPE));
		log.error("ERROR_MESSAGE = {}", request.getAttribute(ERROR_MESSAGE));
